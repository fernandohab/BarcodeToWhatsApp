...
begin
    ...
    {$IFDEF ANDROID}
 //   PermissionsService.RequestPermissions([pCamera, pReadStorage, pWriteStorage], PermissionRequestResult);
    {$ENDIF}
...
procedure TAndroidPermissions.ReadWriteFiles(ACallBack: TCallbackProc = nil;
                                  ACallBackError: TCallbackProc = nil);
begin
...
procedure TAndroidPermissions.PhotoLibrary(ActionLibrary: TTakePhotoFromLibraryAction;
                                      ACallBackError: TCallbackProc = nil);
begin
...
begin
    ...
    {$IFDEF ANDROID}
   // PermissionsService.RequestPermissions([pCoarseLocation, pFineLocation], PermissionRequestResult);
    {$ENDIF}
